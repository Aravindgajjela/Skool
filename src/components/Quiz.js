...
class Quiz extends Component {
    constructor() {
        ...
        this.state = {
            ...
            mcqQuestions: [
              ...
              {
                  question: "What is the output of the expression 3 * 2 + 1 in Python?",
                  options: ["7", "5", "8", "6"],
                  correctAnswer: "7",
                  userAnswer: "",
                  answered: false
              ...
              },
              {
                  ...
                  options: ["Exits the current loop", "Stops the program", "Goes to the next iteration", "None of the above"],
              ...
              },
              {
                  ...
                  options: ["def function_name()", "function function_name()", "define function_name()", "function = name()"],
              ...
              },
              {
                  ...
                  options: ["import module_name", "require module_name", "load module_name", "use module_name"],
              ...
              {
                  question: "Which of the following will give you the absolute value of -5 in Python?",
              ...
              {
                  question: "Which of the following is the correct way to write a dictionary in Python?",
                  options: ["dict = {1: 'apple', 2: 'banana'}", "dict = [1: 'apple', 2: 'banana']", "dict = (1: 'apple', 2: 'banana')", "dict = 'apple', 'banana'"],
            ...
            fillBlankQuestions: [
                ...
                {
                    question: "A variable in Python can hold data like numbers, strings, and ___.",
                ...
                },
                {
                  ...
                  {
                      question: "The function used to get the length of a list in Python is ___.",
                  ...
                  {
                      question: "A variable inside a class but outside any function is called a ___.",
                      options: ["class variable", "global variable", "instance variable", "local variable"],
                      correctAnswer: "class variable",
                      userAnswer: "",
                      answered: false
                  },
                  {
                      question: "To check if a key exists in a dictionary, use the ___ keyword.",
                  ...
                  {
                      question: "In Python, the function used to read input from the user is ___.",
                  ...
                  {
                      question: "The loop used to iterate over a sequence in Python is the ___ loop.",
                  ...
                  {
                      question: "To remove the last item from a list in Python, we use the ___ method.",
                  ...
                  {
                      question: "Python is an ___-level programming language.",
                  ...
                  {
                      question: "The statement used to exit a loop early is ___.",
                  ...
                  {
                      question: "The special method used to initialize an object in Python is ___.",
                      options: ["__start__", "__init__", "__main__", "__object__"],
                      correctAnswer: "__init__",
                      userAnswer: "",
                      answered: false
                  },
                  {
                      question: "A tuple is different from a list because it is ___.",
                  ...
                  {
                      question: "In Python, comments start with the symbol ___.",
                      options: ["//", "/*", "#", "--"],
                      correctAnswer: "#",
                      userAnswer: "",
                      answered: false
                  ...
                  {
                      question: "The operator used for exponentiation in Python is ___.",
                      options: ["^", "**", "^^", "//"],
                      correctAnswer: "**",
                      userAnswer: "",
                      answered: false
                  ...
                  {
                      question: "To open a file in read mode, we use the mode ___.",
                      options: ["w", "a", "r", "x"],
                      correctAnswer: "r",
                      userAnswer: "",
                      answered: false
                  ...
                  {
                      question: "To check the data type of a variable, we use the ___ function.",
                  ...
                  {
                      question: "The function used to convert a string into an integer is ___.",
                  ...
                  {
                      question: "The logical operator that represents 'AND' in Python is ___.",
                      options: ["&", "and", "&&", "AND"],
                      correctAnswer: "and",
                      userAnswer: "",
                      answered: false
    ...
    render() {
        const { mcqQuestions, fillBlankQuestions, currentMCQ, currentFillBlank, quizType, correctAnswersMCQ, wrongAnswersMCQ, correctAnswersFillBlank, wrongAnswersFillBlank } = this.state;
            ...
            <div style={styles.quizContainer}>
                ...
                {quizType === "mcq" && currentMCQ < mcqQuestions.length ? (
                    <div style={styles.mcqContainer}>
                        <p style={styles.questionText}>{mcqQuestions[currentMCQ].question}</p>
                ...
                {quizType === "fillBlank" && currentFillBlank < fillBlankQuestions.length ? (
                    <div style={styles.fillBlankContainer}>
                        <p style={styles.questionText}>{fillBlankQuestions[currentFillBlank].question}</p>
                        <div style={styles.optionsContainer}>
